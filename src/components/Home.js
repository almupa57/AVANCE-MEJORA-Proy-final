    ...
    <div>
      <div className="banner">
        <div className="banner-info">
          <h1>¿Cuánto vale tu Instalación? ¡Descúbrelo ya!</h1>
      ...
      {/* <div id="services"></div> */}
      <main>
        <section className="service-title">Lo que ofrecemos</section>
        ...
        <section className="services-section">
          ...
          <Link to="/resultado" className="link">
            <article className="services-info">
              ...
              <p className="services-info__text" id="news">
                Con esta aplicación, usted a través de un sólo click podrá
        ...
        <section className="news-title">Noticias</section>
        ...
        <section className="news-section">
          ...
          <article className="news-info">
            ...
            <p className="news-info__text" id="team">
        ...
        <section id="team" className="news-title">
          Acerca de mi
        </section>
